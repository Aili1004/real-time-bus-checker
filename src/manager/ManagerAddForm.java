...
/**
 * Servlet implementation class ManagerAddForm
 */
@WebServlet("/ManagerAddForm")
public class ManagerAddForm extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("content", "ManagerAddForm.jsp");
